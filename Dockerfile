...
# docker build -t listingpack .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name listingpack listingpack
...
# Default: Thruster (Kamal). Render overrides with bin/render-start via render.yaml.
EXPOSE 80
